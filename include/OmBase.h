...
#define OM_MAX_PATH       2048    //< hope this will be sufficient for the next 10 years...
#define OM_MAX_ITEM       512     //< most screens are not large enough to print 250 chars in single line...
