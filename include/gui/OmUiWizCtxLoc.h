...
#ifndef OMUIWIZPGLOCCFG_H
#define OMUIWIZPGLOCCFG_H

#include "OmDialog.h"

/// \brief Context Wizard Location params Page
///
/// OmDialog class derived for Context creation Wizard Location params child
/// dialog window
///
