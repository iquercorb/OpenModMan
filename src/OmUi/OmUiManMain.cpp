...
///  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
///
void OmUiManMain::freeze(bool enable)
{
  #ifdef DEBUG
  std::cout << "DEBUG => OmUiManMain::freeze (" << (enable ? "enabled" : "disabled") << ")\n";
  #endif
  ...
  for(size_t i = 0; i < this->_tab_dialog.size(); ++i) {
    ...
    case IDD_MGR_MAIN_LIB:
      static_cast<OmUiManMainLib*>(this->_tab_dialog[i])->freeze(enable);
      break;
    case IDD_MGR_MAIN_NET:
      static_cast<OmUiManMainNet*>(this->_tab_dialog[i])->freeze(enable);
      break;
    }
...
///  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
///
void OmUiManMain::safemode(bool enable)
{
  #ifdef DEBUG
  std::cout << "DEBUG => OmUiManMain::safemode (" << (enable ? "enabled" : "disabled") << ")\n";
  #endif
  ...
  for(size_t i = 0; i < this->_tab_dialog.size(); ++i) {
    ...
    {
    case IDD_MGR_MAIN_LIB:
      static_cast<OmUiManMainLib*>(this->_tab_dialog[i])->safemode(enable);
      break;
    case IDD_MGR_MAIN_NET:
      static_cast<OmUiManMainNet*>(this->_tab_dialog[i])->safemode(enable);
      break;
    }
