...
typedef CURLcode (*curl_ssl_loc_callback)(CURL *curl,    /* easy handle */
...
#define CURLOPT_XFERINFODATA CURLOPT_PROGRESSDATA
  ...
  /* Set the ssl target callback function, currently only for OpenSSL or
     WolfSSL ssl_ctx, or mbedTLS mbedtls_ssl_config in the second argument.
     The function must match the curl_ssl_loc_callback prototype. */
  CURLOPT(CURLOPT_SSL_CTX_FUNCTION, CURLOPTTYPE_FUNCTIONPOINT, 108),

  /* Set the userdata for the ssl target callback function's third
     argument */
...
typedef struct curl_mime_s      curl_mime;      /* Mime target. */
typedef struct curl_mimepart_s  curl_mimepart;  /* Mime part target. */
 ...
 * DESCRIPTION
 *
 * Create a mime target and return its handle. The easy parameter is the
 * target handle.
 */
 ...
 * DESCRIPTION
 *
 * Append a new empty part to the given mime target and return a handle to
 * the created part.
 */
