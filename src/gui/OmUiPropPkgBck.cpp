...
void OmUiPropPkgBck::_onResize()
{
  ...
  this->_setItemPos(IDC_EC_READ3, 70, 58, this->width()-90, 26);
  ...
  this->_setItemPos(IDC_EC_READ4, 70, 106, this->width()-90, 13);
  // Package Backup Installed Files Label
  this->_setItemPos(IDC_SC_LBL05, 5, 122, 64, 9);
  // Package Backup Installed Files EditControl
  this->_setItemPos(IDC_EC_READ5, 70, 122, this->width()-90, this->height()-132);
}
