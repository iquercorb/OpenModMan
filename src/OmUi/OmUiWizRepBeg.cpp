...
///  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
///
OmUiWizRepBeg::OmUiWizRepBeg(HINSTANCE hins) : OmDialogWizPage(hins)
{
...
///  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
///
long OmUiWizRepBeg::id() const
{
  return IDD_WIZ_REP_BEG;
}

///
///  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
///
bool OmUiWizRepBeg::validFields() const
{
  return true;
}
...
///  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
///
bool OmUiWizRepBeg::validParams() const
{
  return true;
}
...
///  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -
///
void OmUiWizRepBeg::_onPgResize()
{
  // Title
